...
import com.shopme.admin.article.ArticleServices;
import com.shopme.common.entity.Article;
import com.shopme.common.entity.ArticleSection;
...
public class ArticleSectionController {
	...
	public String showNewArticleSectionForm(Model model) {
	...
	public String saveArticleSection(Section section, HttpServletRequest request) {
	...
	public String editArticleSection(@PathVariable(name = "id") Integer id, RedirectAttributes ra,
			Model model) {
		try {
