...
import com.shopme.common.entity.BrandSection;
...
public class BrandSectionController {
	...
	public String showNewBrandSectionForm(Model model) {
	...
	public String saveBrandSection(Section section, HttpServletRequest request) {
	...
	public String editBrandSection(@PathVariable(name = "id") Integer id, RedirectAttributes ra,
			Model model) {
		try {
