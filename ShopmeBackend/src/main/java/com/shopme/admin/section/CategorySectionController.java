...
import com.shopme.common.entity.CategorySection;
...
public class CategorySectionController {
	...
	public String showNewCategorySectionForm(Model model) {
	...
	public String saveCategorySection(Section section, HttpServletRequest request) {
	...
	public String editCategorySection(@PathVariable(name = "id") Integer id, RedirectAttributes ra,
			Model model) {
		try {
